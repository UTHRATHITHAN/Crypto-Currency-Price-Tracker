...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed top-0 w-full h-full bg-black bg-opacity-70 first-letter:
    backdrop-blur-sm flex  md:items-center overflow-auto md:overflow-none py-10 md:py-0  justify-center font-nunito
    "
      onClick={close}
    >
      <div
        className="w-[65%] h-[75%] bg-black bg-opacity-40 rounded-lg text-white relative top-0 "
        onClick={(e) => e.stopPropagation()}
      >
        {data ? (
          <div className="flex  items-center justify-between h-full w-full p-4 pt-10">
            <div className="flex flex-col  w-[45%] h-full pr-2 ">
              <div className="flex w-40  gap-x-10 items-center justify-center">
                <img
        ...
        "
          ...
          `}
              ...
              <div className="flex  flex-col gap-y-4  lg:flex-row w-full mt-4 justify-between">
              ...
              <div className="flex flex-col gap-y-5 md:flex-row md:gap-x-10 w-full  ">
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100">
                    Low 24H
                  </span>
              ...
              <div className="flex flex-col gap-y-5 lg:flex-row w-full mt-4 gap-x-10">
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100">
                    max supply
                  </span>
              ...
              <div className="flex w-full mt-4  gap-x-10 justify-between">
                <div className="flex flex-col justify-center">
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    className="text-sm bg-black text-gray-100 px-1.5 py-0.5 my-1 rounded underline	"
          ...
          `}
            ...
            <div className="flex flex-col flex-shrink-0  md:w-[80%] lg:w-[60%] h-full pl-3  hidden md:block">
              <Chart id={data.id} />
          ...
          >
            <div
              ...
              border-b-zinc-800 animate-spin 
             "
              role="status"
            />
